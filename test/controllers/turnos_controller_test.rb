...
class TurnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turno" do
    assert_difference('Turno.count') do
      post turnos_url, params: { turno: { alumno: @turno.alumno, comentario: @turno.comentario, evaluacion: @turno.evaluacion, fecha: @turno.fecha, hora: @turno.hora, imagen: @turno.imagen } }
    end
  ...
  test "should update turno" do
    patch turno_url(@turno), params: { turno: { alumno: @turno.alumno, comentario: @turno.comentario, evaluacion: @turno.evaluacion, fecha: @turno.fecha, hora: @turno.hora, imagen: @turno.imagen } }
